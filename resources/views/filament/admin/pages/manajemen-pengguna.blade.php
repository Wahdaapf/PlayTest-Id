...
<x-filament-panels::page>
    ...
    <style>
        ...
        .mp-search-wrap:focus-within .mp-search-icon {
            color: #2563eb;
        }
        ...
        .mp-table tbody tr:hover td:first-child {
        ...
        .mp-action-btn:hover .mp-tooltip {
            display: block;
        }
            ...
            return {
                ...
                applyFilter() {
                    ...
                    rows.sort((a, b) => {
                        switch (this.sortCol) {
                            case 'nama':
                                return dir * (a.dataset.nama || '').localeCompare(b.dataset.nama || '');
                            case 'role':
                                return dir * (a.dataset.role || '').localeCompare(b.dataset.role || '');
                            case 'status':
                                return dir * (a.dataset.status || '').localeCompare(b.dataset.status || '');
                            case 'tanggal':
                                return dir * ((+a.dataset.tanggal) - (+b.dataset.tanggal));
                            case 'kampanye':
                                return dir * ((+a.dataset.kampanye) - (+b.dataset.kampanye));
                            default:
                                return 0;
                        }
                    });
