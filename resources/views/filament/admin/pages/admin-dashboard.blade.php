                ...
                updateTableSort() {
                    ...
                    rows.sort((a, b) => {
                        ...
                        if (this.sortCol === 'nama') {
                            va = (a.dataset.nama || '').toLowerCase();
                            vb = (b.dataset.nama || '').toLowerCase();
                        } else if (this.sortCol === 'role') {
                            va = (a.dataset.role || '').toLowerCase();
                            vb = (b.dataset.role || '').toLowerCase();
                        } else if (this.sortCol === 'tanggal') {
                            va = +(a.dataset.tanggalSort || 0);
                            vb = +(b.dataset.tanggalSort || 0);
