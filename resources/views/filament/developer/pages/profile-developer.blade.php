  ...
  <div class="px-6 py-6">
    ...
    <div class="w-full rounded-2xl p-6 mb-6 relative overflow-hidden"
      ...
      <div class="relative z-10 flex items-center justify-between flex-wrap gap-4">
        <div>
          <p class="text-xs font-semibold uppercase tracking-widest mb-1" style="color:#e0f2fe;letter-spacing:0.12em;">DEVELOPER PROFILE</p>
        ...
        <div class="flex items-center gap-3 flex-wrap">
          <div class="text-center px-4">
            <p class="font-mono-num text-2xl font-bold text-white">{{ $stats['total_misi'] }}</p>
            <p class="text-xs opacity-70" style="color:#e0f2fe;">Total Kampanye</p>
          </div>
          <div class="w-px h-10 opacity-20" style="background:#ffffff;"></div>
          <div class="text-center px-4">
            <p class="font-mono-num text-2xl font-bold text-white">{{ $stats['misi_selesai'] }}</p>
            <p class="text-xs opacity-70" style="color:#e0f2fe;">Selesai</p>
          </div>
          <div class="w-px h-10 opacity-20" style="background:#ffffff;"></div>
          <div class="text-center px-4">
            <p class="font-mono-num text-lg font-bold text-white" style="font-size:14px;">{{ $stats['member_since'] }}</p>
      ...
      <div class="relative z-10 grid grid-cols-2 sm:flex sm:items-center gap-4 sm:gap-6 mt-5 pt-4"
        ...
        <div>
          ...
          <p class="text-xs opacity-70" style="color:#e0f2fe;">Misi Dibuat</p>
        </div>
        ...
        <div class="hidden sm:block w-px h-8 opacity-20" style="background:#ffffff;"></div>
        <div>
          <p class="font-mono-num text-lg font-bold text-white">{{ $stats['total_misi'] > 0 ? round($stats['misi_selesai'] / $stats['total_misi'] * 100) : 0 }}%</p>
          <p class="text-xs opacity-70" style="color:#e0f2fe;">Tingkat Sukses</p>
        </div>
        <div class="hidden sm:block w-px h-8 opacity-20" style="background:#ffffff;"></div>
        <div>
          <p class="font-mono-num text-lg font-bold text-white">{{ $stats['paket'] }}</p>
          <p class="text-xs opacity-70" style="color:#e0f2fe;">Paket Aktif</p>
        </div>
      </div>
    </div>
