{{-- ============================================================ --}}
{{-- Custom Password Reset Email — PlayTest ID Brand (v2)        --}}
...
<head>
    ...
    <title>{{ __('Reset Kata Sandi Anda — PlayTest ID') }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
    ...
    <style>
        ...
        @media only screen and (max-width: 480px) {
            ...
            .email-info-table td { display:block !important; width:100% !important; text-align:center !important; padding:4px 0 !important; }
...
<body style="margin:0; padding:0; background-color:#eef0f7; font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; -webkit-font-smoothing:antialiased;">
    ...
    <div style="display:none; font-size:1px; color:#eef0f7; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
        {{ __('Reset kata sandi PlayTest ID Anda — tautan aman ini kedaluwarsa dalam 60 menit.') }}
    </div>
                                ...
                                <tr>
                                    <td class="email-hero" style="background:linear-gradient(160deg,#f5f3ff 0%,#eef2ff 100%); background-color:#f5f3ff; padding:44px 40px 28px; text-align:center;">
                                        ...
                                        <h1 class="h1-title" style="margin:0 0 12px; font-size:28px; font-weight:800; color:#1e1b4b; letter-spacing:-0.6px; line-height:1.2;">
                                            {{ __('Reset Kata Sandi Anda') }}
                                        </h1>

                                        <p style="margin:0; font-size:15px; color:#4b5563; line-height:1.75; font-weight:500;">
                                            {!! __('Kami menerima permintaan untuk mereset kata sandi<br>untuk akun <strong style="color:#1e1b4b;">PlayTest ID</strong> Anda.') !!}
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="email-card-body" style="padding:32px 40px 36px;">
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:0 auto 26px;">
                                            <tr>
                                                <td align="center" style="border-radius:14px; background:linear-gradient(135deg,#4F46E5 0%,#7c3aed 100%); background-color:#4F46E5; box-shadow:0 8px 22px rgba(79,70,229,0.38); mso-padding-alt:0;">
                                                    ...
                                                    <w:anchorlock/>
                                                    <center style="color:#ffffff;font-family:'Segoe UI',sans-serif;font-size:16px;font-weight:700;">{{ __('Reset Kata Sandi Saya') }}</center>
                                                    </v:roundrect>
                                                    <![endif]-->
                                                    <!--[if !mso]><!-->
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom:24px;">
                                            <tr>
                                                <td style="background-color:#fffbeb; border:1px solid #fde68a; border-left:4px solid #f59e0b; border-radius:12px; padding:14px 18px;">
                                                    <p style="margin:0; font-size:13px; color:#78350f; line-height:1.6; font-weight:500;">
                                                        {!! __('<strong style="color:#92400e;">&#128161; Tips keamanan:</strong> PlayTest ID tidak akan pernah menanyakan kata sandi Anda melalui email. Selalu reset dari tautan resmi.') !!}
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <p style="margin:0 0 18px; font-size:13px; color:#6b7280; text-align:center; line-height:1.7; font-weight:500;">
                                            {!! __('Tidak memintanya? Anda dapat mengabaikan email ini dengan aman.<br>Kata sandi Anda tidak akan berubah sampai Anda mengklik tombol di atas.') !!}
                                        </p>
                    ...
                    <tr>
                        <td style="text-align:center; padding:28px 16px 0;">
                            ...
                            <p style="margin:0; font-size:12px; color:#9ca3af; line-height:1.7; font-weight:500;">
                                {!! __('Anda menerima email ini karena reset kata sandi<br>diminta untuk akun Anda.') !!}
                            </p>
