{{-- ============================================================ --}}
{{-- Custom Register Page — Split-Screen Light Design               --}}
...
<style>
    /* ================================================================
       REGISTER PAGE — RESET FILAMENT LAYOUT
       ================================================================ */
            ...
            <div class="login-card">
                <div class="login-card-inner">
                    ...
                    <div class="login-card-header">
                        <h2 class="login-card-title">{{ __('Selamat Datang :panel!', ['panel' => str(filament()->getCurrentPanel()->getId())->title()]) }}</h2>
                    ...
                    <div class="login-divider">
                        ...
                        <span class="login-divider-text">{{ __('atau daftar dengan email') }}</span>
                        <div class="login-divider-line"></div>
                    </div>
